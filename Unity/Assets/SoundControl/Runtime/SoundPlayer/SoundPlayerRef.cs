...
namespace ILib.Audio
{
	...
	/// </summary>
	internal class SoundPlayerRef : SoundPlayerRef<string>, ISoundPlayer
	{
		public SoundPlayerRef(SoundPlayer player) : base(player)
		{
		}
	}
	...
	/// SoundPlayerの実体を持つアクセサー
	/// </summary>
	internal class SoundPlayerRef<T> : ISoundPlayer<T>
	{
		SoundPlayer<T> m_Player;
		...
		public SoundPlayerRef(SoundPlayer<T> player)
		{
			m_Player = player;
		}
