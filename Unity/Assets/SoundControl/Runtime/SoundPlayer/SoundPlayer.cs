...
namespace ILib.Audio
{
	...
	{
		public SoundPlayer(Transform root, ISoundProvider<string> provider, SoundPlayerConfig config = null) : base(root, provider, config) { }
	}

	/// <summary>
	/// サウンドプレイヤーの実体です
	/// </summary>
	internal class SoundPlayer<T> : ISoundPlayer<T> , ISoundUpdater
	{
		...
		public SoundPlayer(Transform root, ISoundProvider<T> provider, SoundPlayerConfig config = null)
		{
			m_Provider = provider;
