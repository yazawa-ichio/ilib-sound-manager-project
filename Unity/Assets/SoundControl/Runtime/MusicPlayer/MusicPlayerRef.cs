...
namespace ILib.Audio
{
	...
	/// </summary>
	internal class MusicPlayerRef : MusicPlayerRef<string>, IMusicPlayer
	{
		public MusicPlayerRef(MusicPlayer<string> player) : base(player) { }
	}
	...
	/// MusicPlayerの実体を持つアクセサー
	/// </summary>
	internal class MusicPlayerRef<T> : IMusicPlayer<T>
	{
		MusicPlayer<T> m_Player;
		...
		public MusicPlayerRef(MusicPlayer<T> player)
		{
			m_Player = player;
		}
